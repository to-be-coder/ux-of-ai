...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, }, {"index.mdx": __fd_glob_1, "components/confidence-indicators.mdx": __fd_glob_2, "components/index.mdx": __fd_glob_3, });